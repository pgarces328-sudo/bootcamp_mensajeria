// ============================================================
// EJERCICIO 02 — OAuth PKCE con GitHub
...
// PASO 1: cerrar el browser al volver
...
export default function App(): React.JSX.Element {
  ...
  // PASO 2: Hook useAuthRequest con PKCE
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#1e293b', borderRadius: 12, padding: 16, gap: 10 },
  cardTitle: { fontSize: 15, fontWeight: '600', color: '#61DAFB', marginBottom: 4 },
  statusBadge: { borderRadius: 8, padding: 10, alignItems: 'center' },
  statusText: { color: '#f1f5f9', fontSize: 14, fontWeight: '600' },
  label: { color: '#94a3b8', fontSize: 12, fontWeight: '600' },
  tokenText: { color: '#a78bfa', fontSize: 12, fontFamily: 'monospace' },
  button: { borderRadius: 8, padding: 14, alignItems: 'center' },
  buttonGitHub: { backgroundColor: '#24292e' },
  buttonDisabled: { opacity: 0.45 },
  buttonText: { color: '#fff', fontWeight: '600', fontSize: 14 },
  warningBox: { backgroundColor: '#451a03', borderRadius: 8, padding: 12, borderLeftWidth: 3, borderLeftColor: '#f97316' },
  warningText: { color: '#fed7aa', fontSize: 12, lineHeight: 18 },
});