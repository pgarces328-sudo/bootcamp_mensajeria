...
//
// Dos stores Zustand tipados (Counter + Todo) consumidos
...
// StatsPanel no recibe ningún prop, pero lee useTodoStore directamente
// desde cualquier lugar del árbol.
