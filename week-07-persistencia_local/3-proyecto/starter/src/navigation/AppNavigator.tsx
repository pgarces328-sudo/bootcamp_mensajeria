...
function MainTabs(): React.JSX.Element {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen name="DriversTab" component={DriversScreen} options={{ title: 'Drivers', tabBarLabel: 'Drivers' }} />
      <Tab.Screen name="RoutesTab" component={RoutesScreen} options={{ title: 'Rutas', tabBarLabel: 'Rutas' }} />
      <Tab.Screen name="SettingsTab" component={SettingsScreen} options={{ title: 'Ajustes', tabBarLabel: 'Ajustes' }} />
    </Tab.Navigator>
  );
}
